...
export const AuthorsPreview: React.FC<AuthorsPreviewProps> = ({authors}) => {
    ...
    return (
        <div className="grid gap-x-1 grid-cols-4 pb-4 pt-2 border-solid border-t-4 border-purple-300 content-center">
            {authors.map(author => 
                <div key={author.id} className="w-20 xl:w-56 p-0 xl:p-3 justify-self-center mt-3 rounded-lg bg-gray-300 opacity-90 hover:opacity-100 transition delay-50 duration-100 ease-in-out cursor-pointer">
